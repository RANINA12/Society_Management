...
function sendOtpMail(Email, otp) {
    ...
    let mailOptions = {
        ...
        html: `Please keep your OTP confidential and do not share it with anyone. The OTP will be valid for five minutes only. <br><strong>OTP: ${otp}</strong><br><br>Thank you for choosing Local Handyman!<br><br>If you have any questions, please contact us at:<br>Nikunj Bisani : nikunjbisani@gmail.com.`,
    };
...
function sendJobStartOtpMail(Email, otp) {
    ...
    let mailOptions = {
        ...
        html: `Please share this OTP with the handyman once he arives. <br><strong>OTP: ${otp}</strong><br><br>Thank you for choosing Local Handyman!<br><br>If you have any questions, please contact us at:<br>Nikunj Bisani : nikunjbisani@gmail.com.`,
    };
